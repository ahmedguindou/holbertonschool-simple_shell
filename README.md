...
- `get_line.c` : Reads user input from the command line.
- `parse_line.c` : Parses the input line into arguments.
- `execute_command.c` : Handles execution of user commands.
- `find_command_in_path.c` : Searches for commands in the PATH.
- `_getenv.c` : Fetches environment variables.
